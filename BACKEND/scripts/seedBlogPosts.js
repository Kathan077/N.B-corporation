...
const DEFAULT_POSTS = [
  ...
  },
  {
    ...
    readTime: "6 MIN",
    views: "9.8K",
    image: "/assets/blog_abrasives.png",
  ...
  },
  {
    ...
    readTime: "10 MIN",
    views: "11.5K",
    image: "/assets/blog_adhesives.png",
...
async function seed() {
  ...
  console.log(`✅ Blog Seeding Complete! Inserted: ${inserted}, Updated: ${updated}, Total Articles: ${count}`);
