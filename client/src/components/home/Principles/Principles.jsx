...
import { Shield, Target, Zap, Globe, Users, Award } from 'lucide-react';
...
const Principles = () => {
  ...
  return (
    <section className="principles-section">
      ...
      <div className="watermark" aria-hidden="true">SYSTEMS</div>
      ...
      <div className="principles-container">
        ...
        >
          <h2 className="principles-heading">
            The Principles <br />
            <em className="principles-heading-accent">That Define</em> Mastery
          </h2>
        </motion.div>
