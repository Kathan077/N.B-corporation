      ...
      <div className="testimonial-card-inner">
        ...
        <div className="testimonial-footer">
          ...
          <div className="client-badge">
            <div className="badge-logo-placeholder">{client.charAt(0)}</div>
...
const Testimonials = () => {
  ...
  return (
    <section className="testimonials-section">
      ...
      {/* Watermark */}
      <div className="t-watermark" aria-hidden="true">LEGACY</div>
      ...
      <div className="t-container">
        ...
        <div className="t-header">
          ...
          >
            ...
            <span className="t-eyebrow-text">Testimonials</span>
          </motion.div>
          ...
          >
            Proud Moments <br />
            <em className="t-heading-accent">Happy Clients</em>
          </motion.h2>
        </div>
        ...
        <div className="t-slider-wrapper">
          ...
          <div ref={scrollRef} className="t-slider">
            {testimonials.map((t, i) => (
              <div key={t.id} className="t-slide">
